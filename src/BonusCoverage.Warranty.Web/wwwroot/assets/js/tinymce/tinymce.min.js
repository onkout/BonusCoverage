...
!(function (j) {
  ...
  function Fe(e, t) {
    jt && P(e.dom().scrollIntoViewIfNeeded)
      ...
      getPos: function (e, t, n) {
        ...
        if (((n = n || e), t)) {
          if (
            ...
            "static" === Ze(at.fromDom(e), "position")
          )
            return {
              x: (i =
          ...
          for (r = t.parentNode; r && r !== n && r.nodeType && !et(r, n); )
            (i -= r.scrollLeft || 0),
              ...
              (r = r.parentNode);
          a += (function (e) {
            return rn.isFirefox() && "table" === He(e)
              ? Qe(Ne(e))
                  .filter(function (e) {
                    return "caption" === He(e);
                  })
  ...
  (tt = undefined),
    ...
    (ot = undefined),
    (function (e) {
      "object" == typeof nt && void 0 !== rt
        ? (rt.exports = e())
        : "function" == typeof tt && tt.amd
        ? tt([], e)
      ...
      : ((ln =
        ...
        (En.all = function () {
          var c = Array.prototype.slice.call(
            1 === arguments.length && ln(arguments[0])
              ? arguments[0]
              : arguments
          );
        ...
        (En.resolve = function (t) {
          return t && "object" == typeof t && t.constructor === En
            ? t
            : new En(function (e) {
                e(t);
              });
  ...
  function Pn(e, t) {
    return t
      ? !("array" !== t || !Yn.isArray(e)) || typeof e === t
      : e !== undefined;
  }
  var Ln = {
  ...
  var rr,
    ...
    dr = Qn(["thead", "tbody", "tfoot"]),
    hr = Qn(["td", "th"]),
    mr = Qn(["pre", "script", "textarea", "style"]),
    gr = function (e, t) {
      var n,
        r = t.childNodes;
        ...
        return e.replace(wr, function (e, t) {
          return t
            ? 65535 <
              ...
              : xr[t] || String.fromCharCode(t)
            : ir[e] ||
                rr[e] ||
                (function (e) {
                  var t;
                  return (
                    ((t = at.fromTag("div").dom()).innerHTML = e),
  ...
  function Lr(i) {
    function e(e, t, n) {
      ...
      return (
        r
          ? (r = Mr(r, /[, ]/, Mr(r.toUpperCase(), /[, ]/)))
          : (r = Tr[e]) ||
            ((r = Mr(t, " ", Mr(t.toUpperCase(), " "))),
            (r = Dr(r, n)),
            (Tr[e] = r)),
        r
      );
    ...
    function C(e) {
      var a = /^(~)?(.+)$/;
      e &&
        ((Tr.text_block_elements = Tr.block_elements = null),
        Rr(Hr(e, ","), function (e) {
          var t = a.exec(e),
            n = "~" === t[1],
            r = n ? "span" : "div",
    ...
    i.valid_elements
      ...
      : (Rr(r, function (e, t) {
        ...
        "html5" !== i.schema &&
          Rr(Hr("strong/b em/i"), function (e) {
      ...
      i.invalid_elements &&
        Rr(_r(i.invalid_elements), function (e) {
          z[e] && delete z[e];
        }),
  ...
  var qr = "\ufeff",
    ...
    Zr =
      ((Jr.prototype.bind = function (e, t, n, r) {
        function o(e) {
      ...
      (Jr.prototype.unbind = function (e, t, n) {
        ...
        if ((r = e[this.expando])) {
          if (((c = this.events[r]), t)) {
            ...
            for (u in c)
              (o = c[u]), Fr(e, o.fakeName || u, o.nativeHandler, o.capture);
            c = {};
          }
  ...
  var Qo = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Co) !== ho && fo(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
      ...
      if ((o = Yo.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && to.getElementsByClassName)
            return Do.apply(n, t.getElementsByClassName(a)), n;
        }
  ...
  function ei() {
    ...
    return function r(e, t) {
      return (
        n.push(e + " ") > no.cacheLength && delete r[n.shift()],
        (r[e + " "] = t)
      );
    };
  }
  ...
  (fo = Qo.setDocument = function (e) {
    var t,
      c = e ? e.ownerDocument || e : Co,
      n = c.defaultView;
    return c !== ho && 9 === c.nodeType && c.documentElement
      ? ((mo = (ho = c).documentElement),
        (go = !oo(c)),
        n &&
          n !==
            (function r(e) {
        ...
        (no.find.TAG = to.getElementsByTagName
          ? function (e, t) {
                ...
                (1 &
                  (n =
                    (e.ownerDocument || e) === (t.ownerDocument || t)
                      ...
                      : 1) ||
                (!to.sortDetached && t.compareDocumentPosition(e) === n)
                  ? e === c || (e.ownerDocument === Co && yo(Co, e))
                    ? -1
                    : t === c || (t.ownerDocument === Co && yo(Co, t))
                    ? 1
                    : so
                    ? Oo.call(so, e) - Oo.call(so, t)
                    : 0
                  : 4 & n
                  ? -1
                  : 1)
  ...
  (Qo.attr = function (e, t) {
    ...
    var n = no.attrHandle[t.toLowerCase()],
      r =
        n && To.call(no.attrHandle, t.toLowerCase()) ? n(e, t, !go) : undefined;
    return r !== undefined
      ? r
      : to.attributes || !go
      ? e.getAttribute(t)
  ...
  ((no = Qo.selectors = {
    ...
    filter: {
      ...
      CLASS: function (e) {
        ...
        return (
          t ||
          ((t = new RegExp("(^|" + Ho + ")" + e + "(" + Ho + "|$)")) &&
            zo(e, function (e) {
              return t.test(
                ("string" == typeof e.className && e.className) ||
                  (typeof e.getAttribute != ko && e.getAttribute("class")) ||
                  ""
              );
            }))
        );
      ...
      PSEUDO: function (e, i) {
        var t,
          a =
            no.pseudos[e] ||
            no.setFilters[e.toLowerCase()] ||
            Qo.error("unsupported pseudo: " + e);
        return a[bo]
          ? a(i)
          : 1 < a.length
          ? ((t = [e, e, "", i]),
            no.setFilters.hasOwnProperty(e.toLowerCase())
              ? ti(function (e, t) {
    ...
    pseudos: {
      ...
      lang: ti(function (n) {
        return (
          qo.test(n || "") || Qo.error("unsupported lang: " + n),
    ...
    return (
      ...
      ti(function (e, t, n, r) {
        var o,
          ...
          d = p ? (y || (e ? m : s || v) ? [] : t) : f;
        if ((p && p(f, d, n, r), v))
          for (o = fi(d, c), v(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[c[i]] = !(f[c[i]] = a));
        if (e) {
          if (y || m) {
            if (y) {
  ...
  function hi(e) {
    for (
      ...
      if ((t = no.relative[e[u].type])) l = [si(li(l), t)];
      else {
  ...
  (ui.prototype = no.filters = no.pseudos),
    ...
    (io = Qo.tokenize = function (e, t) {
      ...
      for (a = e, u = [], c = no.preFilter; a; ) {
        for (i in ((n && !(r = Io.exec(a))) ||
          (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
        (n = !1),
        (r = Fo.exec(a)) &&
          ((n = r.shift()),
          o.push({ value: n, type: r[0].replace(Vo, " ") }),
          (a = a.slice(n.length))),
        no.filter))
          no.filter.hasOwnProperty(i) &&
            (!(r = $o[i].exec(a)) ||
              (c[i] && !(r = c[i](r))) ||
              ((n = r.shift()),
    ...
    (uo = Qo.select = function (e, t, n, r) {
      ...
      if (((n = n || []), 1 === l.length)) {
        ...
        for (
          o = $o.needsContext.test(e) ? 0 : i.length;
          o-- && ((a = i[o]), !no.relative[(u = a.type)]);

        )
          if (
            (c = no.find[u]) &&
            (r = c(
              a.matches[0].replace(Jo, Qr),
              (Go.test(i[0].type) && ai(t.parentNode)) || t
            ))
          ) {
            if ((i.splice(o, 1), !(e = r.length && ci(i))))
              return Do.apply(n, r), n;
            break;
          }
      }
      return (
        (s || ao(e, l))(r, t, !go, n, (Go.test(e) && ai(t.parentNode)) || t), n
      );
    }),
  ...
  var zi = j.document,
    ...
    Ai = function (e, t, n, r) {
      var o;
      if (gi(t)) t = pi(t, Pi(e[0]));
      else if (t.length && !t.nodeType) {
        if (((t = Fi.makeArray(t)), r))
  ...
  (bi.fn = bi.prototype = {
    ...
    add: function (e, t) {
      ...
      if (!1 !== t)
        for (
          n = Fi.unique(this.toArray().concat(Fi.makeArray(e))),
          ...
          this[r] = n[r];
      else Ei.apply(this, Fi.makeArray(e));
      return this;
    },
    attr: function (t, n) {
      var e,
    ...
    remove: function () {
      for (var e, t = this.length; t--; )
        (e = this[t]), ki.clean(e), e.parentNode && e.parentNode.removeChild(e);
      return this;
    },
    empty: function () {
      for (var e, t = this.length; t--; )
  ...
  function Li(e, t, n) {
    var r = [],
      o = e[t];
    for (
      "string" != typeof n && n instanceof Fi && (n = n[0]);
      o && 9 !== o.nodeType;
  ...
  function Qi(a, u) {
    ...
    function N(t, e, n) {
      return y(e, function (e) {
        return (
          Jn.is(e, "array") && (t = t.cloneNode(!0)),
          n &&
            $i(Wi(e.childNodes), function (e) {
              t.appendChild(e);
            }),
    ...
    var T = {},
            ...
            if (2 !== l.status)
              if (3 !== l.status) {
                if (
                  ...
                  g.referrerPolicy &&
                    tn(at.fromDom(u), "referrerpolicy", g.referrerPolicy),
                  "onload" in u &&
                    !(
      ...
      O = u.ownEvents ? new Zr() : Zr.Event,
      H = D.getBlockElements(),
      B = Fi.overrideDefaults(function () {
      ...
      F = {
        ...
        getOuterHTML: function (e) {
          ...
          return en.isElement(t)
            ? t.outerHTML
            : Fi("<div></div>").append(Fi(t).clone()).html();
        },
        ...
        split: function (e, t, n) {
          ...
          if (e && t)
            return (
              a.setStart(e.parentNode, Ji(e)),
              a.setEnd(t.parentNode, Ji(t)),
              (r = a.extractContents()),
              (a = S()).setStart(t.parentNode, Ji(t) + 1),
              a.setEnd(e.parentNode, Ji(e) + 1),
              (o = a.extractContents()),
              (i = e.parentNode).insertBefore(pr.trimNode(F, r), e),
              n ? i.insertBefore(n, e) : i.insertBefore(t, e),
              i.insertBefore(pr.trimNode(F, o), e),
              z(e),
              n || t
            );
        },
  ...
  var ea = Qi,
    ...
    ra = Jn.grep,
    oa =
      ((ia.prototype._setReferrerPolicy = function (e) {
          ...
          (i = function () {
            ...
            if (
              ...
              (a.queueLoadedCallbacks.length = 0),
                na(t, function (e) {
                  0 === u.length
                    ? P(e.success) && e.success.call(e.scope)
                    : P(e.failure) && e.failure.call(e.scope, u);
                });
            }
          })();
      }),
        ...
        !1 !== fa.languageLoad &&
          e(
            ...
            function () {
              ...
              !e ||
                (n && -1 === ("," + (n || "") + ",").indexOf("," + e + ",")) ||
                oa.ScriptLoader.add(l[t] + "/langs/" + e + ".js");
            },
            "loaded"
          );
      },
  ...
  function Pa(e) {
    return (
      vu(e) && (e = e.parentNode), pu(e) && e.hasAttribute("data-mce-caret")
    );
  }
  function La(e) {
  ...
  function Fa(e) {
    ...
    return (
      !(!e || !en.isText(t)) &&
      (t.data.charAt(e.offset()) === gu.ZWSP ||
        (e.isAtStart() && La(t.previousSibling)))
    );
  }
  function Ua(e) {
    var t = e.container();
    return (
      !(!e || !en.isText(t)) &&
      (t.data.charAt(e.offset() - 1) === gu.ZWSP ||
        (e.isAtEnd() && La(t.nextSibling)))
    );
  }
  function ja(e, t, n) {
    var r, o;
  ...
  function $a(e) {
    return (
      !ku(e) && (zu(e) ? !Eu(e.parentNode) : Nu(e) || xu(e) || Su(e) || Tu(e))
    );
  }
  function Wa(e, t) {
    return (
  ...
  var cu,
    su = $("mce-annotation"),
    lu = $("data-mce-annotation"),
    fu = $("data-mce-annotation-uid"),
    du = function (e, t) {
    ...
    Cu = en.isContentEditableTrue,
    wu = en.isContentEditableFalse,
    xu = en.isBr,
    zu = en.isText,
    Eu = en.matchNodeNames(["script", "style", "textarea"]),
    Nu = en.matchNodeNames([
      "img",
      "input",
      "textarea",
      "hr",
    ...
    Pu = en.matchStyleValues("float", "left right"),
    Lu = Du(Ou, Hu, c(Pu)),
    ...
    Wu = function (e) {
      ...
      function t(e, t) {
        ...
        0 < t &&
          (n.setStart(e, t - 1), n.setEnd(e, t), iu(n) || r(uu($u(n), !1))),
          t < e.data.length &&
            (n.setStart(e, t), n.setEnd(e, t + 1), iu(n) || r(uu($u(n), !0)));
      }
      var n,
        o,
        i = [];
  ...
  function Yu(e) {
    return (
      (Fc(e) ? "text()" : e.nodeName.toLowerCase()) +
      "[" +
      (function (e) {
        var r, t, n;
        return (
        ...
        (r = Yn.reduce(
          ...
          ? Fc(r)
            ? (function (e, t) {
                ...
                return (
                  Fc(e) && t > e.data.length && (t = e.data.length), Ic(e, t)
                );
              })(r, parseInt(o, 10))
            : ((o = "after" === o ? jc(r) + 1 : jc(r)), Ic(r.parentNode, o))
          : null)
      : null;
  }
  function Ju(e, t) {
  ...
  function oc(e, t) {
    ...
    if (Va(e)) {
      if (
        (en.isText(e) && Pa(e) && (e = e.parentNode),
        (n = e.previousSibling),
        Wc(n))
      )
        return n;
  ...
  function ic(e, t, n) {
    ...
    var a = (function (e) {
      return (
        oc(e.startContainer, e.startOffset) || oc(e.endContainer, e.endOffset)
      );
    })(i);
    return a
      ? { name: (o = a.tagName), index: tc(n.dom, o, a) }
      : (function (e, t, n, r) {
          var o = t.dom,
            i = {};
          return (
            (i.start = ec(o, e, n, r, !0)),
  ...
  function bc(e, t, n) {
    var r,
      ...
      a,
      u,
      c = Xa(t.getBoundingClientRect(), n);
    return (
      (i =
        "BODY" === e.tagName
  ...
  function Cc(e, i, a, t) {
    var n,
      ...
      l = function () {
        !(function (e) {
          var t, n, r, o, i;
          for (t = Fi("*[contentEditable=false]", e), o = 0; o < t.length; o++)
      ...
      f = function () {
        n = Ln.setInterval(function () {
          t()
            ? Fi("div.mce-visual-caret", i).toggleClass(
                "mce-visual-caret-hidden"
              )
            : Fi("div.mce-visual-caret", i).addClass("mce-visual-caret-hidden");
        }, 500);
      };
    return {
      show: function (t, e) {
        ...
        if (!a(e))
          return (
            (u = (function (e, t) {
              var n, r, o;
              if (
                ((r = e.ownerDocument.createTextNode(gu.ZWSP)),
                (o = e.parentNode),
                t)
              ) {
        ...
        var o = Fi('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
          .css(n)
          .appendTo(i)[0];
        return (
          c.set(D.some({ caret: o, element: e, before: t })),
          c.get().each(function (e) {
  ...
  var Lc,
    ...
    Zc = function (e) {
      if (
        (Yc(e) &&
          Va(e) &&
          (Ia(e) ? e.removeAttribute("data-mce-caret") : dc(e)),
        Gc(e))
      ) {
        var t = gu.trim(
          (function (e) {
    ...
    Bs = function (e) {
      return e.getParam(
        "placeholder",
        Qc.getAttrib(e.getElement(), "placeholder"),
        "string"
      );
    },
    Ps = de().browser,
    Ls = en.isContentEditableFalse,
    Vs = en.isContentEditableFalse,
    Is = en.matchStyleValues(
      "display",
  ...
  function rl(e, t) {
    return ql.lastPositionIn(e).fold(
      function () {
        return !1;
      },
      function (e) {
    ...
    if (
      ...
      for (
        a < (i = u.childNodes).length
          ? ((u = i[a]), (r = new Ui(u, e.getParent(u, e.isBlock))))
          : ((u = i[i.length - 1]),
  ...
  function Nl(i, e, t, n, a, r) {
    ...
    return o(t, n, zl)
      ...
      .orThunk(function () {
        return u
          ? D.some({ container: u, offset: a ? 0 : u.length })
          : D.none();
      });
  }
  ...
  function kl(t, e, n, r) {
    ...
    if ((o && e[0].wrapper && (o = Jl(i, o, "ul,ol").reverse()[0] || o), !o))
      for (o = n; o[r] && !i.isBlock(o[r]) && ((o = o[r]), !pl(o, "br")); );
    return o || n;
  }
  ...
  function Al(e, t, n, r) {
    ...
    return (
      ...
      (n[0].inline || n[0].block_expand) &&
        ((n[0].inline && en.isText(o) && 0 !== i) ||
          (o = Tl(c, n, o, i, a, u, !0)),
        (n[0].inline && en.isText(a) && u !== a.nodeValue.length) ||
          (a = Tl(c, n, o, i, a, u, !1))),
      n[0].selector &&
        !1 !== n[0].expand &&
        !n[0].inline &&
        ((o = Sl(c, n, t, o, "previousSibling")),
        (a = Sl(c, n, t, a, "nextSibling"))),
      (n[0].block || n[0].selector) &&
        ((o = kl(e, n, o, "previousSibling")),
        (a = kl(e, n, a, "nextSibling")),
        n[0].block &&
          (c.isBlock(o) || (o = Tl(c, n, o, i, a, u, !0)),
          c.isBlock(a) || (a = Tl(c, n, o, i, a, u, !1)))),
      en.isElement(o) && ((i = c.nodeIndex(o)), (o = o.parentNode)),
      en.isElement(a) && ((u = c.nodeIndex(a) + 1), (a = a.parentNode)),
  ...
  var Rl,
    ...
    Vl = function (e, t, n) {
      ...
      if (_l(c)) {
        ...
        if (Ec(e) && 0 < s && ((o = Ks(c, s - 1)), Bl(o)))
          return !Pl(o) && (i = Sc(o, e, Ll, o))
            ? _l(i)
              ? Ic(i, i.data.length)
              : Ic.after(i)
            : _l(o)
            ? Ic(o, o.data.length)
            : Ic.before(o);
        if (zc(e) && s < c.childNodes.length && ((o = Ks(c, s)), Bl(o)))
          return Hl(o)
            ? (function (e, t) {
                var n = t.nextSibling;
                return n && Bl(n)
      ...
      return ((zc(e) && u.isAtEnd()) || (Ec(e) && u.isAtStart())) &&
        ((r = Sc(r, e, $(!0), n, !0)), Ll(r, n))
        ? Xs(e, r)
        : ((o = Sc(r, e, Ll, n)),
          !(a = Yn.last(
            G(
        ...
        if (
          ...
          return (function (r, e) {
            ...
            return nu(t, n.or(t), function (e, t) {
              var n = r.createRng();
              return (
                n.setStart(nl(r, e.container()), e.offset()),
    ...
    nf = function (e, t, u) {
      ...
      if (0 < a.length)
        ...
        if (
          (1 === n.nodeType && n.hasChildNodes() && (n = Ml(n, r)),
          1 === o.nodeType &&
            o.hasChildNodes() &&
            (o = (function (e, t) {
              return Ml(e, t - 1);
      ...
      i =
        void 0 === o
          ? (function (e) {
              ...
              return (
                e + "_" + Math.floor(1e9 * Math.random()) + ++hu + String(t)
              );
            })("mce-annotation")
          : o,
      a = (function h(e, t) {
  ...
  function wf(e, t, n) {
    ...
    if (
      ...
      r = Jn.trim(md.trimExternal(e.serializer, n.innerHTML));
    else if ("text" === t.format) r = gu.trim(n.innerText || n.textContent);
    else {
  ...
  function _f(e) {
    ...
    return (t && 0 !== t.rangeCount ? D.from(t.getRangeAt(0)) : D.none()).map(
      Df
    );
  }
  function Of(e) {
  ...
  function Pf(t) {
    return (t.bookmark ? t.bookmark : D.none())
      .bind(function (e) {
  ...
  function Uf(e, t) {
    e.focusedEditor === t.editor && (e.focusedEditor = null),
      e.activeEditor || (Md.unbind(j.document, "focusin", ld), (ld = null));
  }
  function jf(t, e) {
    return (function (e) {
      return e.collapsed
        ? D.from(eu(e.startContainer, e.startOffset)).map(at.fromDom)
        : D.none();
    })(e).bind(function (e) {
  ...
  function Yf(e, t) {
    e.dom.setHTML(e.getBody(), t),
      (function (r) {
        Bd(r) &&
          ql.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(),
  ...
  function Gf(t, n, r) {
    return (
      ...
      (r.set = !0),
      (r.content = Xf(n) ? "" : n),
      Xf(n) || r.no_events || (t.fire("BeforeSetContent", r), (n = r.content)),
      D.from(t.getBody()).fold($(n), function (e) {
        return Xf(n)
          ? (function (e, t, n, r) {
              Ef(e.parser.getNodeFilters(), e.parser.getAttributeFilters(), n);
              var o = zf({ validate: e.validate }, e.schema).serialize(n);
              return (
                (r.content = mr(at.fromDom(t)) ? o : Jn.trim(o)),
                Yf(e, r.content),
              ...
              return (
                0 === n.length || /^\s+$/.test(n)
                  ? ((i = '<br data-mce-bogus="1">'),
                    ...
                    e.fire("SetContent", r))
                  : ("raw" !== r.format &&
                      (n = zf({ validate: e.validate }, e.schema).serialize(
  ...
  function Jf(e) {
    if (!e.removed) {
      ...
      r && e.save({ is_removing: !0 }),
        ...
        e.hasHiddenInput && o && Ld.remove(o.nextSibling),
        (function (e) {
          e.fire("remove");
        })(e),
        ...
        ? (t ||
          ...
          (function (e) {
            ...
            t &&
              ...
              Ld.unbind(t, "submit reset", e.formEventDelegate));
          })(e),
          (function (e) {
  ...
  function rd(e, t, n, r) {
    var o = ed(n.forced_plugins),
      i = ed(r.plugins),
      a = (function (e, t) {
        return td(e, t) ? e.sections()[t] : {};
      })(t, "mobile"),
      u = a.plugins ? ed(a.plugins) : i,
      c = (function (e, t) {
          ...
          : {},
        {
          ...
          external_plugins: (function (e, t) {
            ...
            return e && e.external_plugins
              ? Jn.extend({}, e.external_plugins, n)
              : n;
          })(r, a.settings()),
        }
      );
            ...
            "string" == typeof e
              ? U(
                  ...
                  function (e) {
                    var t = e.split("=");
                    1 < t.length
                      ? (n[Jn.trim(t[0])] = Jn.trim(t[1]))
                      : (n[Jn.trim(t[0])] = Jn.trim(t[0]));
                  }
                )
              : (n = e),
            n
  ...
  var ld,
    ...
    dd,
    hd = bf,
    md = { trimExternal: Cf, trimInternal: Cf },
    gd = Jn.makeMap,
    pd = function (e, t) {
      ...
      e.on("init", function () {
        e.inline &&
          (function (e, t) {
            ...
            ea.DOM.bind(j.document, "mouseup", n),
      ...
      e.removed ||
        (t
          ...
          : (function (t) {
              ...
              t.inline || (Kn.opera || $f(n), t.getWin().focus()),
                (Kn.gecko || t.inline) && ($f(n), qf(t, r)),
                Od(t);
            })(e));
    },
    Bd = Kf,
  ...
  function hh(r, a) {
    ...
    function n(e) {
      ...
      !(function (e, t) {
        if ("longpress" !== e.type && 0 !== e.type.indexOf("touch"))
          return M(e.target) && !gh(e.clientX, e.clientY, t);
        var n = e.touches[0];
    ...
    var H = function () {
        ...
        e("width", b),
          ...
          S !== N && (z.unbind(S, "mousemove", _), z.unbind(S, "mouseup", H)),
          z.remove(c),
          z.remove(s),
          B(u),
          (function (e, t, n, r) {
  ...
  var mh = dh,
    ...
    vh = en.isContentEditableFalse,
    yh = en.isContentEditableTrue;
  function bh(e) {
    var t = at.fromDom(j.document),
      n = Ve(t),
      r = (function (e, t) {
        var n = t.owner(e);
        return hm(t, n);
  ...
  function Ah(e, t, n, r) {
    ...
    i.top() < a.y()
      ? Fe(n.element, !1 !== r)
      : i.top() > a.bottom() && Fe(n.element, !0 === r);
  }
  function Mh(e, t, n) {
    return zh(e, Th, t, n);
  }
      ...
      (function (e) {
        ...
        return en.isText(t)
          ? 0 === n
            ? D.some(at.fromDom(t))
            : D.none()
          : D.from(t.childNodes[n]).map(at.fromDom);
      })(e),
      (function (e) {
        ...
        return en.isText(t)
          ? n === t.data.length
            ? D.some(at.fromDom(t))
            : D.none()
          : D.from(t.childNodes[n - 1]).map(at.fromDom);
      })(e),
      function (e, t) {
        var n = g(zm(o), d(ve, e)),
          r = g(Em(o), d(ve, t));
  ...
  function jh(e, t) {
    for (var n = e.rows(), r = 0; r < n.length; r++)
      for (var o = n[r].cells(), i = 0; i < o.length; i++)
        if (ve(o[i], t)) return D.some(km(i, r));
    return D.none();
  }
  ...
  function rm(e, t, n) {
    for (
      var r = new Ui(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
      (t = r[n ? "prev" : "next"]());

    )
      if (en.isBr(t)) return !0;
  }
  function om(e, t, n, r, o) {
    ...
    for (var l, f, d = new Ui(o, s); (a = d[r ? "prev" : "next"]()); ) {
      if (
        ...
        ((f = u), Va((l = a)) && !1 === em(l, f, lc))
      )
        return D.none();
      if (en.isText(a) && 0 < a.nodeValue.length)
        return !1 === tm(a, u, "A")
          ? D.some(Ku(a, r ? a.nodeValue.length : 0))
          : D.none();
  ...
  function im(e, t, n, r) {
    ...
    if (
      ...
      return D.none();
    if (
      (en.isElement(o) && i > o.childNodes.length - 1 && (c = !1),
      en.isDocument(o) && ((o = f), (i = 0)),
      o === f)
    ) {
  ...
  var dm = (function FN(r, o) {
    ...
    mm = /* */ Object.freeze({
      ...
      view: function (e) {
        return (e.dom() === j.document
          ? D.none()
          : D.from(e.dom().defaultView.frameElement)
        ).map(at.fromDom);
      },
      owner: function (e) {
        return ye(e);
    ...
    bm = function (e, t, n) {
      ...
      if (i.caretPositionFromPoint)
        ...
        try {
          ...
          r = (function (e, n, t) {
            ...
            if (
              ...
              0 <
                (i = (i = Jn.toArray(o.getClientRects())).sort(function (e, t) {
                  return (
        ...
        return (function (e, t) {
          ...
          return en.isContentEditableFalse(
            (function (e, t, n) {
              for (; e && e !== t; ) {
                if (n(e)) return e;
                e = e.parentNode;
    ...
    Nm = he("element", "width", "rows"),
    Sm = he("element", "cells"),
    km = he("x", "y"),
    Tm = function (e) {
      var o = Nm(Ha(e), 0, []);
      return (
        U(wa(e, "tr"), function (n, r) {
    ...
    Pm = function (e, t) {
      ...
      if ("text" === t.format)
        return (function (r) {
          return D.from(r.selection.getRng())
            .map(function (e) {
              var t = r.dom.add(
                  r.getBody(),
                  "div",
  ...
  function Um(e) {
    return (
      !(!e || !e.ownerDocument) &&
      Ht(at.fromDom(e.ownerDocument), at.fromDom(e))
    );
  }
  function jm(u, c, e, s) {
    function t(e, t) {
    ...
    var n,
      ...
      h = function () {
        ...
        try {
          (t = d()) &&
            !en.isRestrictedNode(t.anchorNode) &&
            (n =
              0 < t.rangeCount
                ? t.getRangeAt(0)
                : t.createRange
      ...
      m = function (e, t) {
        ...
        if (
          (function (e) {
            return (
              !!e && (!!Fm(e) || (Um(e.startContainer) && Um(e.endContainer)))
            );
          })(e)
        ) {
          var o = Fm(e) ? e : null;
      ...
      g = {
          ...
          return (function (e, t) {
            ...
            return t
              ? ((r = t.startContainer),
                ...
                3 === r.nodeType &&
                  3 === o.nodeType &&
                  ((r = r.length === i ? lm(r.nextSibling, !0) : r.parentNode),
                  (o = 0 === a ? lm(o.previousSibling, !1) : o.parentNode),
                  r && r === o))
                  ? r
                  : n && 3 === n.nodeType
                  ? n.parentNode
        ...
        getSelectedBlocks: function (e, t) {
          return (function (e, t, n, r) {
            ...
            if (
              ((i = e.getRoot()),
              (n = e.getParent(n || cm(i, t, t.collapsed), e.isBlock)),
              (r = e.getParent(r || sm(i, t, t.collapsed), e.isBlock)),
              n && n !== i && a.push(n),
              n && r && n !== r)
            )
        ...
        getBoundingClientRect: function () {
          var e = h();
          return e.collapsed
            ? Ic.fromRangeStart(e).getClientRects()[0]
  ...
  function $m(e, t) {
    var n = Wr();
    t.convert_fonts_to_spans && qm(e, n, Jn.explode(t.font_size_legacy_values)),
      (function (e, n) {
  ...
  function Wm(e, t, n, r) {
    (e.padd_empty_with_br || t.insert) && n[r.name]
      ? (r.empty().append(new gf("br", 1)).shortEnded = !0)
      : (r.empty().append(new gf("#text", 3)).value = $r);
  }
  function Km(t, e, n, r) {
      ...
      e = {
        ...
        parse: function (e, a) {
          ...
          (a = a || {}),
            ...
            (_ = {}),
            (l = ag(
              rg("script,style,head,html,body,title,meta,param"),
              A.getBlockElements()
            ));
          var m,
            ...
            v &&
              ...
              (a.context
                ...
                : (function (e) {
                    ...
                    for (
                      d = rg("tr,td,th,tbody,thead,tfoot,table"),
            ...
            for (d.body = 1, r = 0; r < f; r++)
              if (
                ...
                a === i &&
                  ...
                  (((l = new gf("#text", 3)).value = $r), o.replace(l));
              }
          }),
        ...
        ? (function (e, t, n) {
            ...
            return (
              ...
              (r = j.document.implementation).createHTMLDocument &&
                ...
                Jn.each("BODY" === t.nodeName ? t.childNodes : [t], function (
                  e
                ) {
  ...
  function pg(o) {
              ...
              t(function (e) {
                var t = X(e, function (e, t) {
                  ...
                  return (
                    e.status && Cs(o)
                      ? u(n, e.url)
                      : e.error && fh.uploadError(o, e.error),
    ...
    var f,
      ...
      g = [],
      p = function () {
        return (d = d || mg(m, h)).findAll(o.getBody(), s).then(
          t(function (e) {
            return (
              (e = G(e, function (e) {
      ...
      if ("undefined" == typeof s.length) {
        for (a in s)
          if (s.hasOwnProperty(a)) {
            if (
              ((u = "attributes" === r ? e.getAttrib(t, a) : yl(e, t, a)),
              o && !u && !n.exact)
            )
              return;
  ...
  function wg(e, t, n, r) {
    ...
    return r
      ...
      : ((r = e.selection.getNode()),
        !!yg(e, r, t, n) ||
          !((o = e.selection.getStart()) === r || !yg(e, o, t, n)));
  }
  function xg(r, o, i) {
    var e,
      a = [],
    ...
    return (
      ...
      r.dom.getParent(
        ...
        function (e) {
          var t, n;
          for (t = 0; t < o.length; t++)
            (n = o[t]), !u[n] && op(r, e, n, i) && ((u[n] = !0), a.push(n));
        },
        r.dom.getRoot()
      ),
      a
  ...
  function zg(e, t) {
    ...
    if (u)
      for (
        n = e.selection.getStart(), r = Cl(c, n), i = u.length - 1;
        0 <= i;
        i--
      ) {
    ...
    return (
      t === r && en.isText(t)
        ? 0 < n &&
          ...
          ((t = (r = Eg(t, n)).previousSibling),
          n < o
            ? ((t = r = Eg(r, (o -= n)).previousSibling),
        ...
        : (en.isText(t) &&
          ...
          en.isText(r) &&
            0 < o &&
            o < r.nodeValue.length &&
            (o = (r = Eg(r, o).previousSibling).nodeValue.length)),
            ...
            function (e, t) {
              return cl(t) || Yl(t)
                ? e.previousCharIsSpace ||
                  ...
                  ? { previousCharIsSpace: !1, str: e.str + $r }
  ...
  function Mg(e, t) {
    return (function (e, t) {
      var n = e.container(),
        r = e.offset();
      return (
        !1 === Ic.isTextPosition(e) &&
        n === t.parentNode &&
        r > Ic.before(t).offset()
      );
    })(t, e)
      ? Ic(t.container(), t.offset() - 1)
      : t;
  }
  function Rg(e) {
    return $a(e.previousSibling)
      ...
      : e.previousSibling
      ? ql.lastPositionIn(e.previousSibling)
      : D.none();
  }
  function Dg(e) {
    return $a(e.nextSibling)
      ...
      : e.nextSibling
      ? ql.firstPositionIn(e.nextSibling)
      : D.none();
  }
  function _g(e, t) {
    return Rg(t)
    ...
    return (
      ...
      (function (e, t, n, r) {
        return e.isSome() && t.isSome() && n.isSome()
          ? D.some(r(e.getOrDie(), t.getOrDie(), n.getOrDie()))
          : D.none();
  ...
  function Ug(e) {
    ...
    return (
      Xe(t, { id: fp, "data-mce-bogus": "1", "data-mce-type": "format-caret" }),
      e && Bt(t, at.fromText(lp)),
      t
    );
  }
  function jg(e, t, n) {
  ...
  function qg(e, t, n) {
    ...
    if (t) jg(e, t, n);
      ...
      for (; (t = r.get(fp)); ) jg(e, t, !1);
  }
  function $g(e, t, n) {
    var r = e.dom,
      o = r.getParent(n, d(hl, e));
    o && r.isEmpty(o)
    ...
    t.on("mouseup keydown", function (e) {
      !(function (e, t) {
        ...
        qg(e, null, !1),
          (8 !== t && 46 !== t) ||
            !n.isCollapsed() ||
            n.getStart().innerHTML !== lp ||
            qg(e, fc(r, n.getStart())),
          (37 !== t && 39 !== t) || qg(e, fc(r, n.getStart()));
      })(t, e.keyCode);
    });
  }
  function Yg(e, t) {
    return (
      e.schema.getTextInlineElements().hasOwnProperty(He(t)) &&
      !lc(t.dom()) &&
      !en.isBogus(t.dom())
    );
  }
  ...
  (Zg = function (e) {
    ...
    (t = en.matchNodeNames(["pre"])),
      r.collapsed ||
        ...
        mp(
          hp(hp(n, t), function (e) {
            return (
              t(e.previousSibling) && -1 !== Yn.indexOf(n, e.previousSibling)
            );
          }),
          function (e) {
            !(function (e, t) {
    ...
    if (
      !(function (e, t, n) {
        return (
          !!Hp(t, n.inline) ||
          !!Hp(t, n.block) ||
          (n.selector ? en.isElement(t) && e.is(t, n.selector) : void 0)
        );
      })(a, t, r) &&
      !(function (e, t) {
    ...
    if ("all" !== r.remove) {
      Op(r.styles, function (e, t) {
        (e = vl(a, gl(e, o), t)),
          ...
          (!r.remove_similar && i && !Hp(yl(a, i, t), e)) ||
            a.setStyle(u, t, ""),
          (n = !0);
      }),
        n &&
        ...
        Op(r.attributes, function (e, t) {
          var n;
          if (
            ((e = gl(e, o)),
            "number" == typeof t && ((t = e), (i = null)),
            r.remove_similar || !i || Hp(a.getAttrib(i, t), e))
          ) {
            if (
              "class" === t &&
              (e = a.getAttrib(u, t)) &&
              ((n = ""),
              Op(e.split(/\s+/), function (e) {
                /mce\-\w+/.test(e) && (n += (n ? " " : "") + e);
              }),
              n)
            )
            ...
            "class" === t && u.removeAttribute("className"),
              _p.test(t) && u.removeAttribute("data-mce-" + t),
              u.removeAttribute(t);
          }
        }),
    ...
    return "none" !== r.remove
      ? ((function (t, e, n) {
          ...
          n.block &&
            (a
              ? o === i.getRoot() &&
                ((n.list_block && Hp(e, n.list_block)) ||
                  Op(Jn.grep(e.childNodes), function (e) {
                    ml(t, a, e.nodeName.toLowerCase())
                      ? r
                        ? r.appendChild(e)
                        : ((r = yp(i, e, a)),
              ...
              : i.isBlock(e) &&
                !i.isBlock(o) &&
                (Cp(i, e, !1) ||
                  Cp(i, e.firstChild, !0, !0) ||
                  e.insertBefore(i.create("br"), e.firstChild),
                Cp(i, e, !0) ||
                  Cp(i, e.lastChild, !1, !0) ||
                  e.appendChild(i.create("br")))),
            (n.selector && n.inline && !Hp(n.inline, e)) || i.remove(e, !0);
        })(e, u, r),
        !0)
      : void 0;
  }
  function xp(u, n, a, e, r) {
    function c(e) {
      var t = (function (n, e, r, o, i) {
        var a;
        return (
          Op(Cl(n.dom, e.parentNode).reverse(), function (e) {
            var t;
            a ||
              "_start" === e.id ||
              "_end" === e.id ||
              ((t = op(n, e, r, o, i)) && !1 !== t.split && (a = e));
          }),
          a
        );
      })(u, e, n, a, r);
    ...
    function s(e) {
      ...
      return (
        (function (e) {
          return (
            Xl(e) && en.isElement(e) && ("_start" === e.id || "_end" === e.id)
          );
    ...
    function t(e) {
      ...
      if (f.split) {
        if (((o = Ng(o)), (t = vp(u, o, !0)) !== (n = vp(u, o)))) {
          ...
          (t = yp(h, t, "span", { id: "_start", "data-mce-type": "bookmark" })),
            (n = yp(h, n, "span", { id: "_end", "data-mce-type": "bookmark" }));
          var a = h.createRng();
          a.setStartAfter(t),
            a.setEndBefore(n),
            nf(h, a, function (e) {
    ...
    var o,
      ...
      g = function (e) {
        ...
        if (
          ...
          for (n = 0, r = l.length; n < r && !wp(u, l[n], a, e, e); n++);
        if (f.deep && t.length) {
    ...
    if (e)
      ...
      !h.select("td[data-mce-selected],th[data-mce-selected]").length
        ...
        : ((o = Kc.getPersistentBookmark(u.selection, !0)),
          t(m.getRng()),
          m.moveToBookmark(o),
          f.inline && wg(u, n, a, m.getStart()) && fl(h, m, m.getRng()),
          u.nodeChanged());
    else {
      e = m.getNode();
      for (
        var p = 0, v = l.length;
        p < v && (!l[p].ceFalseOverride || !wp(u, l[p], a, e, e));
        p++
      );
    }
  }
          ...
          Ip(d, function (e) {
            ...
            (!(1 < d.length) && c.isBlock(e)) || 0 !== n)
              ? (C.inline || C.wrapper) &&
                ...
                Ap(m, b, p, e),
                (function (t, n, r, o, i) {
                  (op(t, i.parentNode, r, o) && wp(t, n, o, i)) ||
                ...
                (function (e, t, n, r) {
                  t.styles &&
                    ...
                    Pp(
                      r,
                      Sp(e, "fontSize"),
                      kp(e, "backgroundColor", gl(t.styles.backgroundColor, n))
                    );
                })(c, C, p, e),
                (function (e, t, n, r) {
                  ("sub" !== t.inline && "sup" !== t.inline) ||
                    (Pp(r, Sp(e, "fontSize"), kp(e, "fontSize", "")),
                    e.remove(
          ...
          if (r)
            ...
            !(function (e, t, n) {
              ...
              (a = (r = s.getRng()).startOffset),
                ...
                (o = fc(e.getBody(), s.getStart())) && (i = Fg(o));
              var l = /[^\s\u00a0\u00ad\u200b\ufeff]/;
              c &&
              0 < a &&
              a < c.length &&
            ...
            m.settings.forced_root_block ||
              ...
              Fp(m, b[0].defaultBlock),
              m.selection.setRng(Vp(m.selection.getRng())),
              (t = Kc.getPersistentBookmark(m.selection, !0)),
              e(i, Al(m, a.getRng(), b)),
              C.styles &&
                (function (e, t, n, r) {
                  (t.styles.color || t.styles.textDecoration) &&
                    (Jn.walk(r, d(Tp, e), "childNodes"), Tp(e, r));
                })(i, C, 0, u),
              a.moveToBookmark(t),
              fl(i, a, a.getRng()),
              m.nodeChanged();
  ...
  function $p(e, t) {
    function c(e) {
      ...
      return (
        ...
        (function (e, t) {
          t.classes.length && Wv.addClass(e, t.classes.join(" ")),
            Wv.setAttribs(e, t.attrs);
        })((t = Wv.create(r.name)), r),
        t
      );
    }
    var n,
      ...
      l = function (n, e, t) {
        ...
        if (
          (i = (function (e, t) {
            ...
            return (
              !(!o || !o.length) && (t && -1 !== Jn.inArray(o, t) ? t : o[0])
            );
          })(n, u))
        )
        ...
        return (
          ...
          t &&
            (r || (r = Wv.create("div")).appendChild(n),
    ...
    return e && e.length
      ? ((r = e[0]),
        (n = c(r)),
        (o = Wv.create("div")).appendChild(l(n, e.slice(1), r.siblings)),
        o)
      : "";
  }
  function Wp(e) {
  ...
  function Kp(n, e) {
    ...
    return "preview" in e && !1 === (u = e.preview)
      ...
      : ((t = e.block || e.inline || "span"),
          ...
          return e && "string" == typeof e
            ? ((e = (e = e.split(/\s*,\s*/)[0]).replace(
              ...
              Jn.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
                var t = Jn.map(e.split(/(?:~\+|~|\+)/), Wp),
                  n = t.pop();
                return t.length && (n.siblings = t), n;
              }).reverse())
            : [];
        })(e.selector)).length
          ? (i[0].name || (i[0].name = t), (t = e.selector), $p(i, n))
          : $p([t], n)),
        (o = Wv.select(t, r)[0] || r.firstChild),
        $v(e.styles, function (e, t) {
        ...
        Wv.setStyles(r, { position: "absolute", left: -65535 }),
        n.getBody().appendChild(r),
        (a = Wv.getStyle(n.getBody(), "fontSize", !0)),
        (a = /px$/.test(a) ? parseInt(a, 10) : 0),
        $v(u.split(" "), function (e) {
          var t = Wv.getStyle(o, e, !0);
          if (
            !(
              ("background-color" === e &&
                /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                ((t = Wv.getStyle(n.getBody(), e, !0)),
                "#ffffff" === Wv.toHex(t).toLowerCase())) ||
              ("color" === e && "#000000" === Wv.toHex(t).toLowerCase())
            )
          ) {
  ...
  function Xp(e, t, n, r, o) {
    var i = t.get(n);
    !wg(e, n, r, o) || ("toggle" in i[0] && !i[0].toggle)
      ? Fp(e, n, r, o)
      : xp(e, n, r, o);
  }
  function Yp(e) {
  ...
  function Gp(e) {
    return en.isElement(e)
      ? e.outerHTML
      : en.isText(e)
      ? kr.encodeRaw(e.data, !1)
      : en.isComment(e)
      ? "\x3c!--" + e.data + "--\x3e"
      : "";
  }
      ...
      a = {
        ...
        add: function (e, t) {
          return (function (e, t, n, r, o, i, a) {
            var u = e.settings,
              c = ty(e);
            if (
              ((i = i || {}), (i = Jn.extend(i, c)), !1 === nv(r) || e.removed)
            )
              return null;
            var s = t.data[n.get()];
            if (
        ...
        undo: function () {
          return (function (e, t, n, r) {
            var o;
            return (
              t.typing && (t.add(), (t.typing = !1), rv(t, !1, n)),
              0 < r.get() &&
                (r.set(r.get() - 1),
                (o = t.data[r.get()]),
                ny(e, o, !0),
        ...
        hasUndo: function () {
          return (function (e, t, n) {
            return (
              0 < n.get() || (t.typing && t.data[0] && !ry(ty(e), t.data[0]))
            );
          })(n, a, i);
        },
        hasRedo: function () {
            ...
            if (!e.isDefaultPrevented())
              if ((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t)
                ...
                !(t < 16 || 20 < t) ||
                  ...
                  r.typing ||
                  n ||
                  (r.beforeChange(), rv(r, !0, o), r.add({}, e), a.set(!0));
              }
          }),
        ...
        if (
          ...
          var n = o.getBody(),
            r =
              !(function (e) {
                return (
                  av(e) && !(uv(e) || ("keyup" === e.type && 229 === e.keyCode))
                );
              })(e) &&
              (function (e, t, n) {
          ...
          (("" !== i.getAttrib(n, iy)) === r && !t) ||
            (i.setAttrib(n, iy, r ? u : null),
  ...
  function fv(e, t) {
    if (en.isText(t)) {
      ...
      if (/^\s+$/.test(t.nodeValue) && (!t.nextSibling || lv(e, t.nextSibling)))
        return !0;
    }
    return !1;
  }
    ...
    if (
      ...
      for (
        ...
        if (
          ((y = m),
          (b = g),
          en.isText(b) || (en.isElement(b) && !lv(y, b) && !Xl(b)))
        ) {
          if (fv(m, g)) {
  ...
  function pv(e, t) {
    return e
      ? (function (e) {
          if (cy(e.previousSibling))
            return (
              mv(e.previousSibling) || e.previousSibling.appendData(gu.ZWSP),
              e.previousSibling
            );
      ...
      : (function (e) {
          if (cy(e.nextSibling))
            return (
              hv(e.nextSibling) || e.nextSibling.insertData(0, gu.ZWSP),
              e.nextSibling
            );
  ...
  function bv(e, t) {
    ...
    return e
      ? La(n)
        ...
        : t
      : La(n)
      ? en.isText(n.previousSibling)
        ? Ic(n.previousSibling, n.previousSibling.data.length)
        : Ic.before(n)
      : Ua(t)
      ? Ic(n, r - 1)
      : t;
  ...
  function Rv(n, e, r, t, o, i) {
    return nu(hy.findRootInline(e, r, t), hy.findRootInline(e, r, o), function (
      e,
      t
    ) {
      return e !== t && hy.hasSameParentBlock(r, e, t)
        ? gy.after(n ? e : t)
        : i;
    }).getOr(i);
  }
  ...
  function _v(e, t) {
    return e
      ? t.fold(q(D.some, gy.start), D.none, q(D.some, gy.after), D.none)
      : t.fold(D.none, q(D.some, gy.before), D.none, q(D.some, gy.end));
  }
  function Ov(e, t, n, r) {
    var o = hy.normalizePosition(e, r),
      i = Tv(t, n, o);
    return Tv(t, n, o)
      .bind(d(_v, e))
      .orThunk(function () {
  ...
  function Bv(e, t, n) {
    var r = e ? 1 : -1;
    return (
      t.setRng(Ic(n.container(), n.offset() + r).toRange()),
  ...
  var jv,
    ...
    oy = [
      ...
      ph.LEFT,
      ph.RIGHT,
    ].concat(Kn.browser.isFirefox() ? [224] : []),
    iy = "data-mce-placeholder",
    ay = function (n) {
      var r = ut(D.none()),
        o = ut(!1),
        i = ha(function (e) {
              ...
              sv(e).each(function (t) {
                r.get().each(function (e) {
                  !(function (e, t) {
                    ...
                    (r.set(D.none()), o.set(!1), n.fire("longpresscancel"));
                });
              });
          },
          !0
    ...
    xy = {
      ...
      setupSelectedState: function (t) {
        var n = ut(null),
          r = d(hy.isInlineTarget, t);
        return (
          t.on("NodeChange", function (e) {
            !Lv(t) ||
              (Kn.browser.isIE() && e.initial) ||
              ((function (e, t, n) {
                var r = G(
              ...
              (function (e, t) {
                if (
                  ...
                  Ic.isTextPosition(n) &&
                    !1 === hy.isAtZwsp(n) &&
                    (Pv(e, Jc.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(t, n),
              (function (n, r, o, e) {
  ...
  function zy(o, i, a, e, u, t) {
    function n(e) {
      var t, n, r;
      for (r = Uv([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++)
        if (((n = r[t]), !a(n, c))) {
          if ((0 < l.length && i(n, Yn.last(l)) && s++, (n.line = s), u(n)))
            return !0;
          l.push(n);
        }
    }
  ...
  function Ay(e, o) {
    return Yn.reduce(e, function (e, t) {
      var n, r;
      return (
        (n = Math.min(Sy(e, o), ky(e, o))),
        (r = Math.min(Sy(t, o), ky(t, o))),
        Ty(o, t) ? t : Ty(o, e) ? e : r === n && $y(t.node) ? t : r < n ? t : e
      );
    });
  }
  function My(e, t, n, r) {
    ...
    return (r =
      ...
      Ay(
        (function (e, r) {
          ...
          return (
            o.push(r),
            My(jv.Up, e, d(t, Ga), r.node),
            My(jv.Down, e, d(t, Za), r.node),
            o
          );
        })(e, r),
        t
  ...
  var Fy,
    Uy,
    jy = d(zy, jv.Up, Ga, Za),
    qy = d(zy, jv.Down, Za, Ga),
    $y = en.isContentEditableFalse,
    Wy = Sc,
    Ky = en.isContentEditableTrue,
    Xy = en.isContentEditableFalse,
    Yy = d(By, !0, cl),
    Gy = d(By, !1, cl),
    Zy = Ly(!0, Vy),
    Jy = Ly(!1, Vy),
  ...
  function ob(e, t, n, r) {
    for (
      var o, i, a, u, c, s, l = Ys(n), f = r, d = [];
      f && ((c = l), (s = f), (o = t === Lc.Forwards ? c.next(s) : c.prev(s)));
      ...
      if (o.isVisible()) {
        if (e(f, o)) {
          var h =
            ...
            (a = f),
            (u = o),
            en.isBr(u.getNode(i === Lc.Forwards))
              ? Fy.Br
              : !1 === Tc(a, u)
              ? Fy.Block
              : Fy.Wrap);
          return { positions: rb(t, d), breakType: h, breakAt: D.some(o) };
        }
        d.push(o), (f = o);
      } else f = o;
    }
    ...
    return y(
      ...
      function (e, o) {
        return e.fold(
          ...
          function (r) {
            return nu(z(r.getClientRects()), z(o.getClientRects()), function (
              e,
              t
            ) {
  ...
  function sb(e, t, n, r) {
    ...
    if (
      ((d = Vw(r)),
      (o = Oc(e, t.getBody(), r)),
      (i = n(t.getBody(), Ey(1), o)),
      (a = G(i, Ny(1))),
      (c = Yn.last(o.getClientRects())),
      (tb(o) || Qy(o)) && (d = o.getNode()),
      (nb(o) || eb(o)) && (d = o.getNode(!0)),
      !c)
    )
      return null;
    if (((s = c.left), (u = Ay(a, s)) && Lw(u.node)))
      return (
        (l = Math.abs(s - u.left)),
    ...
    if (d) {
      var h = (function (e, t, n, r) {
        ...
        l = o(
          (c =
            1 === e
              ? ((i = f.next), (a = Za), (u = Ga), Ic.after(r))
              : ((i = f.prev), (a = Ga), (u = Za), Ic.before(r)))
        );
        do {
          if (c.isVisible() && !u((s = o(c)), l)) {
            if (
              (0 < d.length && a(s, Yn.last(d)) && h++,
              ((s = Ka(s)).position = c),
              (s.line = h),
              n(s))
            )
  ...
  function lb(e, t, n) {
    ...
    if (n.collapsed && e.settings.forced_root_block) {
      ...
      (1 === t ? a(Ic.fromRangeStart(n)) : u(Ic.fromRangeStart(n))) ||
        ((o = (function (e) {
  ...
  function hb(n, r) {
    return function () {
      var e = r
          ? Ic.fromRangeEnd(n.selection.getRng())
          : Ic.fromRangeStart(n.selection.getRng()),
  ...
  function zb(t, n) {
    return function () {
      return D.from(t.dom.getParent(t.selection.getNode(), "td,th"))
        .bind(function (e) {
  ...
  function Eb(n, r) {
    return function () {
      return D.from(n.dom.getParent(n.selection.getNode(), "td,th"))
        .bind(function (t) {
  ...
  function Hb(t, n, e) {
    ...
    return nu(r, o, _b).filter(function (e) {
      return (
        ...
        (function (e) {
          return (
            !1 === en.isContentEditableFalse(e.from().block().dom()) &&
            !1 === en.isContentEditableFalse(e.to().block().dom())
          );
        })(e)
      );
    });
  ...
  function $b(e) {
    ...
    return qb(t, n)
      ...
      : (function (n, r) {
          var o = r.getRng();
          return nu(
            Kw(n, at.fromDom(o.startContainer)),
            Kw(n, at.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === ve(e, t) &&
                (o.deleteContents(),
                Zw(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
  ...
  function Kb(e, t, n) {
    var r = G(xm(at.fromDom(n.container()), t), ur),
      o = z(r).getOr(t);
  ...
  function Gb(e, t, n, r) {
    var o = r.getNode(!1 === t);
    return Kw(at.fromDom(e), at.fromDom(n.getNode()))
      .map(function (e) {
  ...
  function Zb(t, n, r) {
    return ql.fromPosition(n, t, r).bind(function (e) {
      return (function (e) {
        ...
        ? D.none()
        : n && en.isContentEditableFalse(e.getNode())
        ? Gb(t, n, r, e)
        : !1 === n && en.isContentEditableFalse(e.getNode(!0))
        ? Gb(t, n, r, e)
        : n && nb(r)
        ? D.some(nx.moveToPosition(e))
        : !1 === n && tb(r)
        ? D.some(nx.moveToPosition(e))
        : D.none();
    });
  ...
  function Jb(t, e, n) {
    return (function (e, t) {
      ...
      ? (function (e, t) {
          return e && en.isContentEditableFalse(t.nextSibling)
            ? D.some(nx.moveToElement(t.nextSibling))
            : !1 === e && en.isContentEditableFalse(t.previousSibling)
            ? D.some(nx.moveToElement(t.previousSibling))
            : D.none();
        })(e, n.getNode(!1 === e)).fold(function () {
          return Zb(t, e, n);
        }, D.some)
      : Zb(t, e, n).bind(function (e) {
  ...
  function eC(t, n) {
    ...
    return Qb(t, e)
      .filter(en.isContentEditableFalse)
      .fold(
        function () {
          return (function (e, t, n) {
            var r = Dc(t ? 1 : -1, e, n),
              ...
              i = at.fromDom(e);
            return !1 === t && nb(o)
              ? D.some(nx.remove(o.getNode(!0)))
              : t && tb(o)
              ? D.some(nx.remove(o.getNode()))
              : !1 === t && tb(o) && Yb(i, o)
              ? ex(i, o).map(function (e) {
                  return nx.remove(e.getNode());
                })
              : t && nb(o) && Xb(i, o)
              ? tx(i, o).map(function (e) {
                  return nx.remove(e.getNode());
                })
              : Jb(e, t, o);
        ...
        .fold(
          function () {
            return (
              ...
              sp(e, t, at.fromDom(e.selection.getNode())),
              Xw(e),
              !0
            );
          },
  ...
  function oC(e, t, n, r) {
    ...
    e.undoManager.ignore(function () {
      e.selection.setRng(
        ...
        vy(i, o, Ic.fromRangeStart(e.selection.getRng())).map(Cy).map(rC(e, t));
    }),
      e.nodeChanged();
  }
  function iC(n, r, o, i) {
    var a = (function (e, t) {
      ...
      u = d(hy.isInlineTarget, n),
      c = vy(u, a, i);
    return c
      .bind(function (e) {
        return o
          ? e.fold($(D.some(Cy(e))), D.none, $(D.some(by(e))), D.none)
          : e.fold(D.none, $(D.some(by(e))), D.none, $(D.some(Cy(e))));
      })
      .map(rC(n, r))
      .getOrThunk(function () {
  ...
  function uC(e, t, n, r) {
    var o = d(Yg, t),
      i = X(G(r, o), function (e) {
        return e.dom();
      });
    if (0 === i.length) sp(t, e, n);
    else {
      var a = (function (e, t) {
        var n = Ug(!1),
          r = Kg(t, n.dom());
  ...
  function bC(n) {
    return (function (n) {
      return nu(
        yC(n.cells(), n.rng().start()),
        yC(n.cells(), n.rng().end()),
        function (e, t) {
  ...
  function MC(e, t) {
    return (
      ...
      (function (e) {
        ...
        ? "margin"
        : "padding") + ("rtl" === Ze(t, "direction") ? "-right" : "-left")
    );
  }
  function RC(e) {
    var t = gx(e);
  ...
  function WC(e, t, n) {
    return !1 === en.isText(t)
      ? n
      : e
      ? 1 === n && t.data.charAt(n - 1) === gu.ZWSP
        ? 0
        : n
      : n === t.data.length - 1 && t.data.charAt(n) === gu.ZWSP
      ? t.data.length
      : n;
  }
  function KC(e, t) {
  ...
  function JC(e, t) {
    ...
    "LI" !== d || h || (l = f),
      c &&
        ...
        !(function (e, t, n) {
          for (
            var r, o = new Ui(t, n), i = e.getNonEmptyElements();
            (r = o.next());
  ...
  function hw(e) {
    var t = us(e),
      n = zx(e.dom, e.selection.getStart());
  ...
  function gw(n, r) {
    var e = r.container(),
      t = r.offset();
    return en.isText(e)
      ? (e.insertData(t, n), D.some(Ku(e, t + n.length)))
      : Hc(r).map(function (e) {
          var t = at.fromText(n);
  ...
  function yw(e, t) {
    return pw(t)
      ? Gy(t)
      : Gy(t) || ql.prevPosition(vw(e, t).dom(), t).exists(Gy);
  }
  function bw(e, t) {
    return pw(t)
      ? Yy(t)
      : Yy(t) || ql.nextPosition(vw(e, t).dom(), t).exists(Yy);
  }
  function Cw(e) {
    return Hc(e)
      .bind(function (e) {
  ...
  function Tw(t) {
    ...
    t.selection.isCollapsed() &&
      kw(e, Ku.fromRangeStart(t.selection.getRng())).each(function (e) {
  ...
  function Dw(e, t) {
    var n = (function (e) {
      return Ta(at.fromDom(e.getBody()), "*[data-mce-caret]").fold(
        $(null),
        function (e) {
          return e.dom();
        }
    ...
    if (n)
      return "compositionstart" === t.type
        ...
        : void (Ia(n) && (Rw(e, n), e.undoManager.add()));
  }
  function _w(t) {
    !(function (e) {
      var t = da(function () {
  ...
  var Ow = d(ob, Ku.isAbove, -1),
    Hw = d(ob, Ku.isBelow, 1),
    Bw = d(ib, -1, Ow),
    Pw = d(ib, 1, Hw),
    Lw = en.isContentEditableFalse,
    Vw = Qa,
    Iw = d(
      mb,
      function (e) {
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t, n) {
            ...
            $w(
              [
                { keyCode: ph.RIGHT, action: fb(e, !0) },
                { keyCode: ph.LEFT, action: fb(e, !1) },
                { keyCode: ph.UP, action: db(e, !1) },
                { keyCode: ph.DOWN, action: db(e, !0) },
                { keyCode: ph.RIGHT, action: zb(e, !0) },
                { keyCode: ph.LEFT, action: zb(e, !1) },
                { keyCode: ph.UP, action: Eb(e, !1) },
                { keyCode: ph.DOWN, action: Eb(e, !0) },
                { keyCode: ph.RIGHT, action: xy.move(e, t, !0) },
                { keyCode: ph.LEFT, action: xy.move(e, t, !1) },
                {
                  keyCode: ph.RIGHT,
                  ctrlKey: !r.isOSX(),
                  altKey: r.isOSX(),
    ...
    ix = function (e) {
      var t,
        n = rx(e.getBody(), e.selection.getNode());
      return (
        en.isContentEditableTrue(n) &&
          e.dom.isBlock(n) &&
          e.dom.isEmpty(n) &&
        ...
        return (
          ...
          (function (e) {
            return Sa(e, function (e) {
              return (
                en.isContentEditableTrue(e.dom()) ||
                en.isContentEditableFalse(e.dom())
              );
            }).exists(function (e) {
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t, n) {
            $w(
              [
                { keyCode: ph.BACKSPACE, action: qw(Cx, e, !1) },
                { keyCode: ph.BACKSPACE, action: qw(ox, e, !1) },
                { keyCode: ph.DELETE, action: qw(ox, e, !0) },
                { keyCode: ph.BACKSPACE, action: qw(ax, e, !1) },
                { keyCode: ph.DELETE, action: qw(ax, e, !0) },
                { keyCode: ph.BACKSPACE, action: qw(ux, e, t, !1) },
                { keyCode: ph.DELETE, action: qw(ux, e, t, !0) },
                { keyCode: ph.BACKSPACE, action: qw(hx, e, !1) },
                { keyCode: ph.DELETE, action: qw(hx, e, !0) },
                { keyCode: ph.BACKSPACE, action: qw(mx, e, !1) },
                { keyCode: ph.DELETE, action: qw(mx, e, !0) },
                { keyCode: ph.BACKSPACE, action: qw(Qw, e, !1) },
                { keyCode: ph.DELETE, action: qw(Qw, e, !0) },
                { keyCode: ph.BACKSPACE, action: qw(Jw, e, !1) },
                { keyCode: ph.DELETE, action: qw(Jw, e, !0) },
                { keyCode: ph.BACKSPACE, action: qw(cx, e, !1) },
                { keyCode: ph.DELETE, action: qw(cx, e, !0) },
              ],
              n
            ).each(function (e) {
              n.preventDefault();
        ...
        t.on("keyup", function (e) {
          !1 === e.isDefaultPrevented() &&
            (function (e, t) {
              $w(
                [
                  { keyCode: ph.BACKSPACE, action: qw(ix, e) },
                  { keyCode: ph.DELETE, action: qw(ix, e) },
                ],
                t
              );
            })(t, e);
      ...
      if (t) {
        if (/^(LI|DT|DD)$/.test(t.nodeName)) {
          ...
          u &&
            ...
            t.insertBefore(i.doc.createTextNode($r), t.firstChild);
        }
    ...
    kx = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        if (UC(n, r, !0) && UC(n, r, !1))
          VC(n, "LI") ? i.insertAfter(u, FC(n)) : i.replace(u, n);
        else if (UC(n, r, !0))
          VC(n, "LI")
            ? (i.insertAfter(u, FC(n)),
        ...
        (u = KC(y, c)) &&
          ...
          /^(LI|DT|DD)$/.test(m) && y.isEmpty(s)
            ...
            : (p && s === a.getBody()) ||
              ((p = p || "P"),
              Pa(s)
                ? ((f = qa(s)), y.isEmpty(s) && jC(s), YC(a, f), xx(a, f))
                : n()
                ? r()
                : n(!0)
                ...
                : ((o = (function (e) {
                    ...
                    return (
                      t.setStart(
                        e.startContainer,
                        WC(!0, e.startContainer, e.startOffset)
                      ),
                      t.setEnd(
                        e.endContainer,
                        WC(!1, e.endContainer, e.endOffset)
                      ),
                      t
                    );
                  ...
                  y.isEmpty(s) && jC(s),
                  f.normalize(),
                  y.isEmpty(f) ? (y.remove(f), r()) : (YC(a, f), xx(a, f))),
              y.setAttrib(f, "id", ""),
    ...
    Ox = function (e, t) {
      return my(
        [
          mw([iw], _x.none()),
          mw([cw("summary", !0)], _x.br()),
          mw([sw(!0), lw(!1), dw], _x.br()),
          mw([sw(!0), lw(!1)], _x.block()),
          mw([sw(!0), lw(!0), dw], _x.block()),
          mw([sw(!0), lw(!0)], _x.br()),
          mw([uw(!0), dw], _x.br()),
          mw([uw(!0)], _x.block()),
          mw([aw(!0), dw, hw], _x.block()),
          mw([aw(!0)], _x.br()),
          mw([fw], _x.br()),
          mw([aw(!1), dw], _x.br()),
          mw([hw], _x.block()),
    ...
    Vx = function (t) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            $w([{ keyCode: ph.SPACEBAR, action: qw(Mw, e) }], t).each(function (
              e
            ) {
              t.preventDefault();
            });
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            $w(
              [
                { keyCode: ph.END, action: hb(e, !0) },
                { keyCode: ph.HOME, action: hb(e, !1) },
              ],
              t
            ).each(function (e) {
              t.preventDefault();
    ...
    qx =
      (($x.prototype.nodeChanged = function (e) {
        var t,
          n,
          r,
    ...
    "onselectionchange" in r.getDoc() ||
      r.on("NodeChange click mouseup keyup focus", function (e) {
        ...
        (n = {
          ...
          ("nodechange" !== e.type && Lm(n, o)) || r.fire("SelectionChange"),
          (o = n);
      }),
      ...
      r.on("SelectionChange", function () {
        ...
        !e ||
          (!Kn.range && r.selection.isCollapsed()) ||
          (Ih(r) &&
      ...
      r.on("mouseup", function (e) {
        !e.isDefaultPrevented() &&
          ...
          ("IMG" === r.selection.getNode().nodeName
            ? Ln.setEditorTimeout(r, function () {
                r.nodeChanged();
              })
            : r.nodeChanged());
      });
      ...
      3 <= e.detail &&
        (function (e) {
          ...
          if (Ku.isElementPosition(n)) {
            var o = n.container();
            Kx(o) &&
              ql.firstPositionIn(o).each(function (e) {
          ...
          if (Ku.isElementPosition(r)) {
            o = n.container();
            Kx(o) &&
              ql.lastPositionIn(o).each(function (e) {
    ...
    var v,
      ...
      u = function (e) {
        var t = g.schema.getShortEndedElements(),
          ...
          a = e.endOffset;
        return (
          te(t, r.nodeName.toLowerCase())
            ? 0 === o
              ? n.setStartBefore(r)
              : n.setStartAfter(r)
            : n.setStart(r, o),
          te(t, i.nodeName.toLowerCase())
            ? 0 === a
              ? n.setEndBefore(i)
              : n.setEndAfter(i)
            : n.setEnd(i, a),
      ...
      c = function (e, t) {
        ...
        if (
          ...
          return null;
        if (
          (u === a + 1 && i === e.endContainer && (n = i.childNodes[a]), !Hz(n))
        )
          return null;
        if (
          ((l = f = n.cloneNode(!0)),
          ...
          return null;
        (r = Ta(at.fromDom(g.getBody()), "#" + b).fold(
          function () {
            return d([]);
          },
          function (e) {
          ...
          l === f && Kn.ie
            ? (r
              ...
              e.setEndAfter(l))
            : (r.empty().append($r).append(l).append($r),
        ...
        var m = at.fromDom(n);
        return (
          U(wa(at.fromDom(g.getBody()), "*[data-mce-selected]"), function (e) {
        ...
        (function () {
          g.on("mouseup", function (e) {
            ...
            g.on("click", function (e) {
              var t;
              (t = ez(g, e.target)) &&
                (Hz(t) && (e.preventDefault(), g.focus()),
                Oz(t) && g.dom.isChildOf(t, g.selection.getNode()) && s());
            }),
          ...
          function i(e, t) {
            ...
            return (
              !(!n || !g.dom.isChildOf(n, r) || !1 !== Hz(ez(g, n))) ||
              (n &&
                !(function (e, t) {
                  return (
          ...
          (n = g).on(
            ...
            g.on("mousedown", function (e) {
              ...
              if (
                ...
                !1 !== Qd(g, e.clientX, e.clientY)
              )
                if ((t = ez(g, n)))
                  Hz(t)
                    ? (e.preventDefault(), c(_y(g, t)))
                    : (s(),
                      (Oz(t) && e.shiftKey) ||
                        gh(e.clientX, e.clientY, g.selection.getRng()) ||
            ...
            g.on("keypress", function (e) {
              ph.modifierPressed(e) ||
                (e.keyCode, Hz(g.selection.getNode()) && e.preventDefault());
            }),
        ...
        })(),
      {
        ...
        showBlockCaretContainer: function (e) {
          e.hasAttribute("data-mce-caret") &&
            (qa(e), a(r()), g.selection.scrollIntoView(e));
        },
        hideFakeCaret: w,
        destroy: function () {
          o.destroy(), (v = null);
  ...
  function rz(e) {
    e.bindPendingEventDelegates(),
      ...
      (function (r) {
        var e = r.dom.getRoot();
        r.inline ||
          (Ih(r) && r.selection.getStart(!0) !== e) ||
          ql.firstPositionIn(e).each(function (e) {
            var t = e.getNode(),
              n = en.isTable(t) ? ql.firstPositionIn(t).getOr(e) : e;
            Kn.browser.isIE()
              ? Nd(r, n.toRange())
    ...
    !(function (e, t, n, r) {
      ...
      if (K(i)) {
        if (!cz(i) && !rh.urls.hasOwnProperty(i)) {
          var a = o.theme_url;
          a
            ? rh.load(i, t.documentBaseURI.toAbsolute(a))
            : rh.load(i, "themes/" + i + "/theme" + n + ".js");
        }
  ...
  function bz(e, t, n) {
    ...
    if (
      ...
      (r = e.parser),
      (h = n.merge),
      (o = zf({ validate: e.settings.validate }, e.schema)),
      (d =
      ...
      p === v &&
        ...
        m.setRng(l)),
        m.isCollapsed() ||
          (e.selection.setRng(Vp(e.selection.getRng())),
      ...
      if (((u = r.parse(t, y)), !0 === n.paste && $z(e.schema, u) && Kz(g, i)))
        return (
          (l = Wz(o, g, e.selection.getRng(), u)),
  ...
  var Tz = function (e, t) {
      return (function (e, t, n) {
        ...
        (function (e, t) {
          ...
          var n = Yx(e.getContentAreaContainer()),
            r = (function (e) {
              var t = e.getBody(),
    ...
    Az = en.isContentEditableFalse,
    Mz = en.isContentEditableTrue,
    Rz = function (e) {
          ...
          n.on("drop", function (e) {
            var t =
              "undefined" != typeof e.clientX
                ...
                : null;
            (Az(t) || Az(n.dom.getContentEditableParent(t))) &&
              e.preventDefault();
          });
        })(e);
    },
    ...
    Oz = en.isContentEditableTrue,
    Hz = en.isContentEditableFalse,
    Bz = ea.DOM,
    Pz = function (t, e) {
      var n,
        r,
            ...
            e.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
              for (
                ...
                (t = e[n]).isEmpty(r) &&
                  ...
                  (t.append(new gf("br", 1)).shortEnded = !0);
            }),
            e
          );
        })(t)),
        (t.serializer = Jm(o, t)),
        (t.selection = jm(t.dom, t.getWin(), t.serializer, t)),
        (t.annotator = sf(t)),
        (t.formatter = Yp(t)),
        (t.undoManager = iv(t)),
        (t._nodeChangeDispatcher = new qx(t)),
        (t._selectionOverrides = tz(t)),
        ay(t),
        Wx(t),
        Xx(t),
        jx(t),
    ...
    Vz = function (e, t) {
      var n = oz(e, t);
      t.editorContainer &&
        ((Lz.get(t.editorContainer).style.display = e.orgDisplay),
        (e.hidden = Lz.isHidden(t.editorContainer))),
        (e.getElement().style.display = "none"),
        Lz.setAttrib(e.id, "aria-hidden", "true"),
        n || Pz(e);
    },
    Iz = ea.DOM,
    Fz = function (t, n, e) {
      ...
      if (((e = Jn.trim(e)), r && -1 === Jn.inArray(n, e))) {
        if (
          (Jn.each(nh.dependencies(e), function (e) {
            Fz(t, n, e);
          }),
          t.plugins[e])
        )
      ...
      e.fire("ScriptsLoaded"),
        ...
        (function (e) {
          ...
          if (K(t)) {
            ...
            var n = rh.get(t);
            (e.theme = new n(e, rh.urls[t])),
              e.theme.init &&
                e.theme.init(
                  e,
                  rh.urls[t] || e.documentBaseUrl.replace(/\/$/, ""),
                  e.$
                );
          } else e.theme = {};
        })(e),
      ...
      if (Zr.Event.domLoaded) {
        if (t.getElement() && Kn.contentEditable) {
          ...
          o &&
            ((t.formElement = o),
            e.hidden_input &&
              !en.isTextareaOrInput(t.getElement()) &&
              (jz.insertAfter(
                jz.create("input", { type: "hidden", name: n }),
                n
              ),
              (t.hasHiddenInput = !0)),
            ...
            jz.bind(o, "submit reset", t.formEventDelegate),
            t.on("reset", function () {
              t.resetContent();
            }),
            !e.submit_patch ||
            ...
            (t.windowManager = oh(t)),
            (t.notificationManager = th(t)),
            "xml" === e.encoding &&
    ...
    Wz = function (e, o, i, t) {
      ...
      var r = (function (e, t, n) {
        ...
        a = gz(o, i.startContainer),
        u = mz(dz(r.firstChild)),
        c = o.getRoot();
      return n(1)
        ? vz(a, u, c)
        : n(2)
    ...
    Xz = en.matchNodeNames(["td", "th"]),
    Yz = function (e, t) {
      var n = (function (e) {
        var t;
        return "string" != typeof e
          ? ((t = Jn.extend({ paste: e.paste, data: { paste: e.paste } }, e)),
    ...
    Jz = { "font-size": "size", "font-family": "face" },
    Qz = {
      getFontSize: zz("font-size"),
    ...
    nE = Jn.inArray,
    rE =
      ((oE.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (
            (eE(this.editor.plugins, function (e) {
      ...
      (oE.prototype.setupCommands = function (i) {
        ...
        this.addCommands({
          ...
          "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone": function (
            ...
            var t = e.substring(7);
            "full" === t && (t = "justify"),
              eE("left,center,right,justify".split(","), function (e) {
          ...
          FontSize: function (e, t, n) {
            !(function (e, t) {
              e.formatter.toggle("fontsize", { value: Sz(e, t) }),
                e.nodeChanged();
            })(i, n);
          },
    ...
    aE =
      ...
      (uE.prototype.on = function (e, t, n, r) {
        ...
        if ((!1 === t && (t = s), t)) {
          var u = { func: t };
          for (
            r && Jn.extend(u, r), a = (i = e.toLowerCase().split(" ")).length;
            a--;
    ...
    sE(n, "mce-content-readonly", t),
      t
        ...
        : ((e.readonly = !1),
          ...
          lE(e, "StyleWithCSS", !1),
          lE(e, "enableInlineTableEditing", !1),
          lE(e, "enableObjectResizing", !1),
          Pd(e) && e.focus(),
          (function (e) {
            e.selection.setRng(e.selection.getRng());
          })(e),
  ...
  function mE(t) {
    t.parser.addAttributeFilter("contenteditable", function (e) {
      hE(t) &&
        U(e, function (e) {
          e.attr(xE, e.attr("contenteditable")),
  ...
  function gE(e, t) {
    return "selectionchange" === t
      ...
      ? (e.eventRoot || (e.eventRoot = zE.select(e.settings.event_root)[0]),
        e.eventRoot)
      : e.getBody();
  }
  function pE(e, t, n) {
  ...
  function vE(i, a) {
    ...
    if ((i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed))
      if (((e = gE(i, a)), i.settings.event_root)) {
        if (
          (CE ||
            ((CE = {}),
  ...
  function yE(e, t, n, r) {
    ...
    o.deactivate(),
      o.editorReadOnly !== i.editorReadOnly && dE(e, i.editorReadOnly),
      t.set(r),
      (function (e, t) {
  ...
  var CE,
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(gE(n, e), e, n.delegates[e]),
    ...
    ME =
      ((RE.prototype.add = function (e, n, r, o) {
        var t,
          i = this;
        return (
          "string" == typeof (t = r)
      ...
      (RE.prototype.parseShortcut = function (e) {
        ...
        for (n in (SE(kE(e.toLowerCase(), "+"), function (e) {
          e in AE
            ...
            : ((r.charCode = e.charCodeAt(0)),
              (r.keyCode = TE[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        AE))
          r[n] ? t.push(n) : (r[n] = !1);
        return (
          (r.id = t.join(",")),
          r.access && ((r.alt = !0), Kn.mac ? (r.ctrl = !0) : (r.shift = !0)),
          r.meta && (Kn.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
          r
        );
      }),
      (RE.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = Jn.map(kE(e, ">"), this.parseShortcut))[
            o.length - 1
          ] = Jn.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
          Jn.extend(o[0], {
    ...
    if (/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)) r.source = e;
      ...
      if (
        ...
        var i = this.settings.base_uri
          ...
          : new LE(j.document.location.href).directory;
    ...
    qE =
      ...
      ($E.prototype.getContent = function (e) {
        return (function (t, n) {
          return (
            void 0 === n && (n = {}),
            D.from(t.getBody()).fold(
              $("tree" === n.format ? new gf("body", 11) : ""),
              function (e) {
                return wf(t, n, e);
              }
            )
      ...
      ($E.prototype.resetContent = function (e) {
        e === undefined
          ? Gf(this, this.startContent, { format: "raw" })
          : Gf(this, e),
      ...
      ($E.prototype.addVisual = function (e) {
        ...
        (e = e || r.getBody()),
          ...
          FE(i.select("table,a", e), function (e) {
            var t;
            switch (e.nodeName) {
              case "TABLE":
                return (
  ...
  function $E(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      IE(this, EE),
      (this.settings = id(this, e, this.documentBaseUrl, n.defaultSettings, t)),
      ...
      this.settings.referrer_policy &&
        (oa.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
      ...
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new PE(this.settings.document_base_url, {
        base_uri: this.baseUri,
      })),
      (this.baseURI = this.baseUri),
      (this.inline = !!this.settings.inline),
      (this.shortcuts = new ME(this)),
      (this.editorCommands = new rE(this)),
      this.settings.cache_suffix &&
        (Kn.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, "")),
      (this.ui = { registry: DE() });
    var o = bE(this);
    (this.mode = o),
      (this.setMode = o.set),
  ...
  function KE(e) {
    e !== nN &&
      (e
        ? Fi(window).on("resize scroll", WE)
        : Fi(window).off("resize scroll", WE),
      (nN = e));
  }
  function XE(t) {
    var e = oN;
    ...
    return (
      ...
      aN.activeEditor === t && (aN.activeEditor = 0 < oN.length ? oN[0] : null),
      aN.focusedEditor === t && (aN.focusedEditor = null),
      e.length !== oN.length
    );
  }
  var YE,
    ...
    rN = [],
    oN = [],
    iN = "CSS1Compat" !== j.document.compatMode,
    aN = ne(ne({}, wE), {
      baseURI: null,
      baseURL: null,
      defaultSettings: {},
      ...
      setup: function () {
        var e,
          t,
          n = "";
        (t = PE.getDocumentBaseUrl(j.document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
            ((t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
            /[\/\\]$/.test(t) || (t += "/"));
        ...
        (this.baseURL = new PE(t).toAbsolute(e)),
          (this.documentBaseURL = t),
          (this.baseURI = new PE(this.baseURL)),
          (this.suffix = n),
          Rd(this);
      },
      ...
      init: function (r) {
        ...
        function s(e) {
          ...
          return (
            t ||
              ((t = (t = e.name) && !ZE.get(t) ? e.name : ZE.uniqueId()),
              e.setAttribute("id", t)),
            t
          );
        }
        ...
        var f = function (e) {
          ...
          e = function () {
            ...
            ZE.unbind(window, "ready", e),
                    ...
                    case "exact":
                      0 < (e = t.elements || "").length &&
                        QE(JE(e), function (t) {
                          ...
                          (e = ZE.get(t))
                            ? n.push(e)
                            : QE(j.document.forms, function (e) {
              ...
              r.types
                ? QE(r.types, function (t) {
                    Jn.each(o, function (e) {
                      return (
                        !ZE.is(e, t.selector) || (n(s(e), eN({}, r, t), e), !1)
                      );
                    });
                  })
                : (Jn.each(o, function (e) {
        ...
        if (e) {
          if (!K(e))
            return (
              ...
              H(r.get(n.id))
                ? null
                : (XE(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === oN.length &&
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new PE(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new PE(this.baseURL));
      },
  ...
  aN.setup(),
    ((GE = uN = uN || {}).compareRanges = Lm),
    (GE.getCaretRangeFromPoint = bm),
    (GE.getSelectedNode = Qa),
    (GE.getNode = eu);
  function cN(e, t, n) {
    var r, o, i, a, u, c;
    return (
  ...
  var lN,
    ...
    gN =
      ...
      (fN = {}),
      {
        ...
        add: function (e, t) {
          fN[e] !== undefined && (fN[e](t), delete fN[e]),
            (lN[e] = xn.resolve(t));
        },
      }),
    pN = Math.min,
    ...
    CN = {
      ...
      intersect: function (e, t) {
        ...
        return (
          ...
          o - n < 0 || i - r < 0 ? null : bN(n, r, o - n, i - r)
        );
      },
  ...
  sN.extend = dN = function (n) {
    ...
    (hN = !1),
    n.Mixins &&
      (wN(n.Mixins, function (e) {
        for (var t in e) "init" !== t && (n[t] = e[t]);
      }),
      u.Mixins && (n.Mixins = u.Mixins.concat(n.Mixins))),
    n.Methods &&
      wN(n.Methods.split(","), function (e) {
        n[e] = t;
      }),
    n.Properties &&
      wN(n.Properties.split(","), function (e) {
        var t = "_" + e;
        n[e] = function (e) {
    ...
    n.Statics &&
      wN(n.Statics, function (e, t) {
        r[t] = e;
      }),
    n.Defaults && u.Defaults && (n.Defaults = xN({}, u.Defaults, n.Defaults)),
    n))
  ...
  var zN = Math.min,
    ...
    TN = ne(ne({}, wE), {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ""),
          TN.fire("beforeInitialize", { settings: e }),
          ...
          if (
            ...
            e.requestheaders &&
              Jn.each(e.requestheaders, function (e) {
                t.setRequestHeader(e.key, e.value);
              }),
            t.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
            (t = TN.fire("beforeSend", { xhr: t, settings: e }).xhr).send(
              e.data
            ),
            !e.async)
          )
    ...
    AN = Jn.extend,
    MN =
      ((RN.sendRPC = function (e) {
        return new RN().send(e);
      }),
      (RN.prototype.send = function (e) {
        var n = e.error,
          r = e.success,
          o = AN(this.settings, e);
        (o.success = function (e, t) {
          void 0 === (e = SN.parse(e)) && (e = { error: "JSON Parse error." }),
            e.error
